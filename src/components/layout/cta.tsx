...
export default function CallToAction() {
  return (
    <section className="py-8 bg-[#F8F8F8] rounded-3xl mx-14 mb-16 p-8">
      <div className='container mx-auto px-6 flex flex-col md:flex-row items-center'>
        <div className="text-left md:mb-30">
          <h2 className="text-[28px] md:text-[52px] font-semibold">Be part of <span className='text-[#189132]'>Africa&apos;s</span></h2>
          <h2 className="text-[28px] md:text-[52px] font-semibold mb-4">mobility revolution.</h2>
