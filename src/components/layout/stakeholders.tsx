        ...
        <div className="container mx-auto px-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mx-auto">
            <Card className="bg-transparent p-8 rounded-2xl border border-[#231F20] flex flex-col h-full">
              ...
              <h3 className="text-[26px] md:text-[32px] text-[#231F20] font-semibold mb-2 md:mb-4">For Drivers</h3>
              <p className="text-[20px] md:text-[27px] text-[#231F20] mb-4 md:mb-8 font-light">Earn more, spend less with Zolt EV + BaaS.</p>
            ...
            <Card className="bg-transparent p-8 rounded-2xl border border-[#231F20] flex flex-col h-full">
              ...
              <h3 className="text-[26px] md:text-[32px] text-[#231F20] font-bold mb-2 md:mb-4">For Dealers & Partners</h3>
